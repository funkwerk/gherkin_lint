Gem::Specification.new do |s|
  ...
  s.authors     = ['Nigel Brookes-Thomas', 'Stefan Rohe', 'Nishtha Argawal', 'John Gluck']
  s.homepage    = 'http://github.com/funkwerk/gherkin_lint/'
  s.license     = 'MIT'
  s.files       = `git ls-files`.split("\n")
  
  s.executables = s.files.grep(%r{^bin/}) { |file| File.basename(file) }
  s.add_runtime_dependency 'amatch', '~> 0.4.0'
  s.add_runtime_dependency 'engtagger', '~> 0.2'
  s.add_runtime_dependency 'cucumber', '~> 3.0'
  s.add_runtime_dependency 'multi_json', '~> 1.0'
  s.add_runtime_dependency 'term-ansicolor', '1.7.0'
